            ...
            if active_model_id:
                ...
                if products:
                    for product_store in products:
                        ...
                        project_dictionary ={'user_id':self.assigned_to_id.id,'project_id':self.project_task_id.id,'date_deadline':self.deadline,'sale_order_id':order_obj.id,'partner_id':customer_name,'name':order_name,'sale_order_date':confirm_date,'products_task_ids':[(6,0,store_products)]}
